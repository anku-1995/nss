<?php
/**
 * Template Name: Vovational Training Programs Template
...
?>
	...
	<section class="vtp_section">
		<div class="container">
			<div class="owl-carousel vtp_carousel">
                    <?php
                  $post_lists = get_posts( array(
                       ...
                       'tax_query' => array(
                            array(
                                ...
                                'terms'    => 22,      // provide the term slugs
                            ),
                        ),
                    ) );
	...
	<section class="center_carousel">
		<div class="container">
			<div class="heading">
				<h2>glimpse of <span>Traning Program</span></h2>
			</div>
                         ...
                         'posts_per_page' => 3,
                          'tax_query' => array(
                            array(
                                ...
                                'field'    => 'term_id',          // term_id, slug or name  (Define by what you want to search the below term)    
                                'terms'    => 20,      // provide the term slugs
                            ),
                        ),
                    ) );
                foreach($post_lists as $posts){ ?>
                         ...
                         'posts_per_page' => 3,
                          'tax_query' => array(
                            array(
                                ...
                                'field'    => 'term_id',          // term_id, slug or name  (Define by what you want to search the below term)    
                                'terms'    => 7,      // provide the term slugs
                            ),
                        ),
                    ) );
                foreach($post_lists as $posts){ ?>
