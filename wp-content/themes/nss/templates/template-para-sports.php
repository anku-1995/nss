<?php
/**
 * Template Name: Para Sports Template
...
?>
	...
	<section class="devendra_jhajharia">
		<div class="container">
			<div class="inner">
				<div class="img_block">
		...
		<div class="container">
			<div class="inner">
				<div class="program_block">
					<h3>Our Programs</h3>
					<div class="owl-carousel program_carousel">
                        <?php
                  $post_lists = get_posts( array(
                         'post_type' => 'parasportsprogram',
                         'post_status' => 'publish',
                         'orderby' => 'ID', 
                         'order' =>'asc',
                         'posts_per_page' => -1,
				...
				<div class="benefit_block">
					...
					<ul class="benefit_list">
                        <?php   wp_reset_query();
                            ...
                            the_row();
                            $main_content= get_sub_field('title');
                            $imurl= get_sub_field('image')['url'];

                           ?>
						<li>
							<div class="icon"><img src="<?=$imurl?>" alt=""></div>
							<p><?=$main_content?></p>
						</li>
                       <?php  
                        endwhile;   
                         ...
                         'posts_per_page' => -1,
                          'tax_query' => array(
                            array(
                                ...
                                'field'    => 'term_id',          // term_id, slug or name  (Define by what you want to search the below term)    
                                'terms'    => 15,      // provide the term slugs
                            ),
                        ),
                    ) );
                foreach($post_lists as $posts){ ?>
                         ...
                         'posts_per_page' => -1,
                          'tax_query' => array(
                            array(
                                ...
                                'field'    => 'term_id',          // term_id, slug or name  (Define by what you want to search the below term)    
                                'terms'    => 14,      // provide the term slugs
                            ),
                        ),
                    ) );
                foreach($post_lists as $posts){ ?>
