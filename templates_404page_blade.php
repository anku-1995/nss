...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/404/responsive.css') }}">
...
<!-- End Google Tag Manager (noscript) -->
        ...
        <div class="header-right">
          ...
          <div class="bottom">
            <ul class="menu-list">
              ...
              <li  class="drop-down"><a href="javascript:;">Products</a><span><i class="fa fa-angle-down"></i></span>
                <div class="submenu">
                  <ul class="drop_list">
                    <li><a href="{{ URL('/window') }}">Windows</a>
                          <ul class="sub-menu">
                         @php
              ...
              <li><a href="https://www.fenesta.com/VisualizeDesign/index.html">Customize</a></li>
               <li class="drop-down"><a href="javascript:;">Contact Us</a><span><i class="fa fa-angle-down"></i></span>
                  <div class="submenu">
                  <ul class="">
            ...
            <div class="mob-locate-icon">
              <img class="" src="{{ asset('images/site_images/images/locate-icon-blue.png') }}"> Gurugram
    ...
    <div class="not-found-sec">
      <div class="container-fluid">        
        <div class="image" data-aos="zoom-in">
          <picture>
            <source srcset="{{ asset('images/404/not-found.png')}}" media="(min-width:768px)">
            <source srcset="{{ asset('images/404/not-found-mob.png')}}" media="(min-width:320px)">
            <img src="{{ asset('images/404/not-found.png')}}">
          </picture> 
        </div>
        <div class="back-home text-center" ><a href="{{url('/')}}" class="blue-btn white"> Back to home</a></div>
      </div>    
    </div>
      <footer>
        <div class="container-fluid">
  ...
  <div class="back-to-top">
    ...
    <a href="#banner">
      <img src="{{asset('images/site_images/images/back-top.png')}}">
    </a>
  </div>
      ...
      <div class="modal-content">      
        ...
        <div class="modal-body">          
          <div class="content">
            ...
            <form class="enquiry-form" id="enquiry-form" action="{{url('/submit-enquiry')}}" method="post" novalidate>
                 @csrf
              <div class="form-group">
...
<a class="whatspp_icon" href="https://api.whatsapp.com/send?phone=917428691568&text=Hi" style="text-decoration: none;" target="_blank">
