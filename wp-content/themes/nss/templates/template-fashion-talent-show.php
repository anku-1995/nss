<?php
/**
 * Template Name: Fashion Talent Show Template
...
?>
	...
	<section class="devendra_jhajharia jyoti">
		<div class="container">
			<div class="inner">
				<div class="img_block">
                         ...
                         'posts_per_page' => 3,
                          'tax_query' => array(
                            array(
                                ...
                                'terms'    => 10,      // provide the term slugs
                            ),
                        ),
                    ) );
                         ...
                         'posts_per_page' => 3,
                          'tax_query' => array(
                            array(
                                ...
                                'field'    => 'term_id',          // term_id, slug or name  (Define by what you want to search the below term)    
                                'terms'    => 11,      // provide the term slugs
                            ),
                        ),
                    ) );
                foreach($post_lists as $posts){ ?>
