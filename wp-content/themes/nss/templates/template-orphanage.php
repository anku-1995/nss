<?php
/**
 * Template Name: Orphanage Template
...
?>
	...
	<section class="orphanage_section">
		<div class="container">
			<div class="inner">
				<div class="img_block">
				...
				<div class="img_block right">
					<img src="<?=get_stylesheet_directory_uri()?>/assets/images/orphanage-img02.png" alt="">
				</div>
				<div class="copy">
	...
	<section class="center_carousel">
		<div class="container">
			<div class="heading">
				<h2>glimpse of <span>Orphanage Activities</span></h2>
			</div>
                         ...
                         'posts_per_page' => -1,
                          'tax_query' => array(
                            array(
                                ...
                                'terms'    => 12,      // provide the term slugs
                            ),
                        ),
                    ) );
                         ...
                         'posts_per_page' => -1,
                          'tax_query' => array(
                            array(
                                ...
                                'field'    => 'term_id',          // term_id, slug or name  (Define by what you want to search the below term)    
                                'terms'    => 13,      // provide the term slugs
                            ),
                        ),
                    ) );
                foreach($post_lists as $posts){ ?>
